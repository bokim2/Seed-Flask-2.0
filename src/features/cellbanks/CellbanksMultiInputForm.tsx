...
export default function CellbanksMultiInputForm() {
  ...
  const initialMultiInputData = [{row: 0, strain: '', target_molecule: '', description: '', notes: ''}]
  ...
  return (
    <>
      <BulkInputTextArea onChange={e => setbulkTextAreaInput(e.target.value)}></BulkInputTextArea>
      ...
      <StyledForm onSubmit={handleSubmit}>
        <StyledTable>
          <CellbankFormBody>
            {bulkForm.length !== 0 && bulkForm?.map((row, i) => (
              <TableRow key={i}>
                {/* <InputContainer>
