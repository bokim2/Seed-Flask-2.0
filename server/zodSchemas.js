...
// sample search schema - make all keys optional
...
export const sampleSearchSchema = createSampleSchema
  .extend({
...
export const sampleSearchSchemaArray = z.array(sampleSearchSchema);